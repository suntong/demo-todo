...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/demo-todo","GOAPP_STATIC_RESOURCES_URL":"/demo-todo","GOAPP_VERSION":"9c9184cf08d917b32c4b7e46416fc51fad389683"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/demo-todo/web/app.wasm", showProgress),
      go.importObject
    );
